...
<div style={{width:'40%',display:'flex',alignItems:'center',justifyContent:'center',padding:'20px 50px',fontFamily:'poppins',fontWeight:'400',fontSize:'24px',color:'#E2BF44'}}><button style={{backgroundColor:'#E2BF44',padding:'10px 20px',color:'white',fontFamily:'Inter',fontWeight:'400',fontSize:'32px',borderRadius:'72px',border:'none'}}>Add To Cart</button></div>  
</div>
