...
function Footer() {
  ...
  return (
   ...
   <div style={{height:'90%',width:'80%',display:'flex',flexDirection:'column',alignItems:'center'}}>
    <div style={{width:'100%'}}>
    <div style={{display:'flex',flexDirection:'row',justifyContent:'space-between',width:'100%',color:'white',margin:'50px 0px 20px 0px'}}>
        <div style={{width:'32%'}}>
    ...
    <div style={{height:'10%',width:'95%',display:'flex',flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
